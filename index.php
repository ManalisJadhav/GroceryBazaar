...
<html>
	<head>
		<title>Welcome to Manali's online grocery</title>
	...
	<body style="min-width: 980px;">
		...
		<div class="home-welcome">
			<div class="home-welcome-text" style="background-image: url(image/bg.jpeg); height: 380px; ">
				<div style="padding-top: 100px;">
					<div>
						<h1 style="margin: 0px 30px; color: #fff;">Welcome To Manali's online grocery</h1>
						<h2 style="margin: 0px 30px; color: #fff;">Everything at your doors in one click</h2>
					</div>
				</div>
			</div>
		</div>
		<div class="home-prodlist">
			...
			<div style="padding: 20px 20px 20px 110px; width: 85%; margin: 0 auto;">
				<ul style="float: left;">
